...
func calc_ratio(campaignid string)int {
	plog("current ratio:"+strconv.FormatFloat(cur_ratio[campaignid], 'E', -1, 64)+ " agent_cnt:"+strconv.FormatFloat(agent_cnt[campaignid]) +" num queue:"+strconv.Itoa(num_queue[campaignid]),1)
